...
class BootimgBiosPlusEFIPlugin(SourcePlugin):
    ...
    name = 'bootimg-biosplusefi-tb'

    __GRUBLEG_MODULE_NAME = "bootimg-grub-tb"
    ...
    def __instanciateSubClasses(cls):
        ...
        # Import bootimg-grub-tb (class name "BootimgGrubTbPlugin")
        modulePath = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  cls.__GRUBLEG_MODULE_NAME + ".py")
        loader = SourceFileLoader(cls.__GRUBLEG_MODULE_NAME, modulePath)
        mod = types.ModuleType(loader.name)
        loader.exec_module(mod)
        cls.__imgBiosObj = mod.BootimgGrubTbPlugin()
